...
base_burrito <- "veggie"
switch(base_burrito,
       "veggie" = print ("A veggie burrito is the cost of a base burrito"),
       "chicken" = print ("A chicken burrito costs 3.00 more than a base burrito"),
       "steak" = print ("A steak burrito costs 3.25 more than a base burrito"))
```
